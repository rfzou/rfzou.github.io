            ...
            if (this.stop !== !0) {
                ...
                e.timeout = setTimeout(function() {
                    ...
                    if ("html" === e.contentType && "<" === t.substr(s).charAt(0)) {
                        for (var n = ""; ">" !== t.substr(s).charAt(0); )
                            n += t.substr(s).charAt(0),
                            s++;
                        s++,
                        n += ">"
                    }
                    e.timeout = setTimeout(function() {
                        if (s === t.length) {
                            ...
                            e.attr ? e.el.attr(e.attr, o) : "html" === e.contentType ? e.el.html(o) : e.el.text(o),
                            s++,
                            e.typewrite(t, s)
                        }
                    }, o)
        ...
        backspace: function(t, s) {
            if (this.stop !== !0) {
                ...
                e.timeout = setTimeout(function() {
                    ...
                    var i = e.elContent + t.substr(0, s);
                    e.attr ? e.el.attr(e.attr, i) : "html" === e.contentType ? e.el.html(i) : e.el.text(i),
                    s > e.stopNum ? (s--,
